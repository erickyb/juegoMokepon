...
function iniciarMapa(){
    ...
    mascotaJugadorObjeto = obtenerObjeMascota(mascotaJugador)
...
function revisarColision(enemigo) {
    ...
    if (  
        ...
        console.log('se detecto colisison')
